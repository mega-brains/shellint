 ...
 * `tsc -p config/tsconfig.shelly.base.json` spawn in scripts/build-shelly.mjs. A Worker
 * cannot read config/tsconfig.shelly.base.json off disk, so its compiler options are
 ...
 * stays equivalent to what config/tsconfig.shelly.base.json itself parses to — a future
...
/**
 * Mirrors config/tsconfig.shelly.base.json's `compilerOptions` verbatim (see that file
